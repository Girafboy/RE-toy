#ifndef TC_PRE_CHECK_H
#define TC_PRE_CHECK_H
...
//    char* read_buff_1;
    ...
    int main_pre_check(const Graph &graph) {
        // read DAG
//        if (argc == 1) {
//            usage();
//            return 1;
//        }
        int i = 1;
        string tmp_res_file_name = "../tmp/TFL/"s + graph.getName();
        const char *resfilename = tmp_res_file_name.c_str();
//        char resfilename[] = "../../tmp/TFL/"; // *resfilename="../index/"
//        while (i < argc) {
...
//        FILE *in_file = fopen(filename, "r");
        ...
        Hdfs();
        for(const char *i=resfilename; *i != '\0'; i++){
            label_name[tgraph2++]=*i;
        }
        pt2=tgraph2;
        DAG();  // store dag_label
        topoSort_B();  // store topo_label
