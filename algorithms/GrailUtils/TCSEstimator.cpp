...
namespace grail {
    ...
    void TCSEstimator::propagate_down(GrailGraph &g, int *visited, int node, double val, int step, double *avg) {
        GrailEdgeList el = g.in_edges(node);
    ...
    void TCSEstimator::find_mins(GrailGraph &g, int *visited, int *reverse, double *avg, int step, int totalsample) {
